...
# Load GPT-3 data
gpt3_gen_acc = np.load('./exp1_GPT_3.5_turbo_instruct_data/all_probcat_gen_acc.npz')
gpt3_MC_acc = np.load('./exp1_GPT_3.5_turbo_instruct_data/all_probcat_MC_acc.npz')
...
hide_top_right(ax)
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(1.2,1))
results_fname = plot_dir + 'gen_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
...
hide_top_right(ax)
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(1.2,1))
results_fname = plot_dir + 'MC_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
gpt3_gen_acc_onerule = np.load('./exp1_GPT_3.5_turbo_instruct_data/all_onerule_gen_acc.npz')
gpt3_MC_acc_onerule = np.load('./exp1_GPT_3.5_turbo_instruct_data/all_onerule_MC_acc.npz')
...
results_fname = plot_dir + 'onerule_gen_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(1.2,1))
plt.title('One-rule problems', fontsize=title_fontsize)
results_fname = plot_dir + 'onerule_MC_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
# Load GPT-3 one-rule data
gpt3_gen_acc_tworule = np.load('./exp1_GPT_3.5_turbo_instruct_data/tworule_prog_vs_noprog_gen_acc.npz')
...
hide_top_right(ax)
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(0.85,1))
plt.title('Two-rule problems', fontsize=title_fontsize)
results_fname = plot_dir + 'tworule_prog_vs_noprog_gen_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
# Load GPT-3 one-rule data
gpt3_gen_acc_logic = np.load('./exp1_GPT_3.5_turbo_instruct_data/aligned_vs_permuted_gen_acc.npz')
gpt3_MC_acc_logic = np.load('./exp1_GPT_3.5_turbo_instruct_data/aligned_vs_permuted_MC_acc.npz')
...
results_fname = plot_dir + 'logic_aligned_vs_permuted_gen_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(1.2,1))
plt.title('Logic problems', fontsize=title_fontsize)
results_fname = plot_dir + 'logic_aligned_vs_permuted_MC_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
# Load GPT-3 one-rule data
gpt3_gen_acc_tworule = np.load('./exp1_GPT_3.5_turbo_instruct_data/tworule_prob_N_unique_rules_gen.npz')
gpt3_MC_acc_tworule = np.load('./exp1_GPT_3.5_turbo_instruct_data/tworule_prob_N_unique_rules_MC.npz')
gpt3_gen_acc_tworule_mn = gpt3_gen_acc_tworule['acc']
gpt3_gen_acc_tworule_err = gpt3_gen_acc_tworule['err']
...
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(1.2,1))
plt.title('Two-rule problems', fontsize=title_fontsize)
results_fname = plot_dir + 'tworule_rel_complexity_gen_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
plt.xlabel('Number of unique rules', fontsize=plot_fontsize)
hide_top_right(ax)
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(0.75,1))
plt.title('Two-rule problems', fontsize=title_fontsize)
results_fname = plot_dir + 'tworule_rel_complexity_MC_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
# Load GPT-3 one-rule data
gpt3_gen_acc_threerule = np.load('./exp1_GPT_3.5_turbo_instruct_data/threerule_prob_N_unique_rules_gen.npz')
gpt3_MC_acc_threerule = np.load('./exp1_GPT_3.5_turbo_instruct_data/threerule_prob_N_unique_rules_MC.npz')
...
results_fname = plot_dir + 'threerule_rel_complexity_gen_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
...
plt.legend(['GPT-3.5','Human'],fontsize=plot_fontsize,frameon=False,bbox_to_anchor=(1.2,1))
plt.title('Three-rule problems', fontsize=title_fontsize)
results_fname = plot_dir + 'threerule_rel_complexity_MC_gpt3.5_vs_human.png'
ax.set_aspect(2.5)
plt.tight_layout()
plt.savefig(results_fname, dpi=300, bbox_inches="tight")
plt.close()
